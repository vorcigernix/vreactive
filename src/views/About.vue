<template>
  <div class="content">
    ...
    <p>
      ...
      ReactiveConf. Our main goal is to make an event with a positive impact on
      our society. We believe that technology is a great tool to help other
      people and every year we will aim to raise awareness about problems we see
      around us and turn this awareness into action. And, yes, we want to have a
